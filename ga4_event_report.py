...
def _render_group_summary_bar(group_name: str, events: list, data: dict) -> str:
    ...
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:20px;
      ...
      <span style="background:{bg};color:{col};font-size:11px;font-weight:700;
        ...
        {fmt_pct(pct)} vs previous 28 days
      </span>
...
<div class="wrapper">
  ...
  <!-- HEADER -->
  <div class="header">
    <div class="header-eyebrow">CIM SEO Platform · 28-Day Event Intelligence</div>
  ...
  <div class="body-pad" style="padding-bottom:0;">
    <p style="font-size:13px;color:{C_SLATE};line-height:1.7;margin-bottom:8px;">
      ...
      in GA4 for the past 28 days (<strong>{date_range_label}</strong>).
      All period-over-period (PoP) comparisons are against the prior 28 days
      ({prev_range_label}).
    </p>
  ...
  <div class="footer">
    ...
    PoP = period-over-period change. All metrics reflect the date range shown above.
  </div>
...
def main():
    print("=" * 70, flush=True)
    print("GA4 CUSTOM EVENT 28-DAY REPORT", flush=True)
    print("=" * 70, flush=True)
    ...
    curr_start, curr_end, prev_start, prev_end = get_28day_windows()
